(function initMazuUsersTable() {
  ...
  console.log("appContainer?.dataset?.baseUrl", appContainer?.dataset?.baseUrl);
        ...
        if (user.email === currentUserEmail) {
          ...
          actionHtml = `
                        <div class="action-buttons">
                            <a data-spa href="${baseUrl}/users/${user.id}" class="btn-act" title="Lihat">👁️</a>
                            <a data-spa href="${baseUrl}/users/${user.id}/edit" class="btn-act" title="Edit">✏️</a>
