...
<div class="app-layout">
  <div class="app-sidebar">
    ...
    <div class="widget-nav-menu">
      <a data-spa href="<?= getBaseUrl('/agenda') ?>" class="widget-nav-item <?= $currentStatus === null ? 'active' : '' ?>">
      ...
      <a data-spa href="<?= getBaseUrl('/agenda?status=pending') ?>" class="widget-nav-item <?= $currentStatus === 'pending' ? 'active' : '' ?>">
        <div class="widget-nav-dot" style="background-color: var(--warning-main);"></div>
        Menunggu
      </a>
      <a data-spa href="<?= getBaseUrl('/agenda?status=approved') ?>" class="widget-nav-item <?= $currentStatus === 'approved' ? 'active' : '' ?>">
        <div class="widget-nav-dot" style="background-color: var(--success-main);"></div>
        Disetujui
      </a>
      <a data-spa href="<?= getBaseUrl('/agenda?status=rejected') ?>" class="widget-nav-item <?= $currentStatus === 'rejected' ? 'active' : '' ?>">
        <div class="widget-nav-dot" style="background-color: var(--error-main);"></div>
        Ditolak
      </a>
    </div>
  </div>
