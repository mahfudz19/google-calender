...
/**
 * View: Pengajuan Saya (My Agenda)
 * Layout: Status Cards (Stacked List)
 * Variabel: $myAgendas (Array of agenda items)
 */

// Data Dummy untuk Preview (Jika controller belum kirim data)
$myAgendas = [
  [
    'id' => 101,
    'title' => 'Diskusi Tim Q1',
    'start_time' => date('Y-m-d 10:00:00'),
    'end_time' => date('Y-m-d 12:00:00'),
    'location' => 'R. Meeting Kecil',
    'status' => 'pending',
    'created_at' => date('Y-m-d H:i:s')
  ],
  [
    'id' => 102,
    'title' => 'Presentasi Client A',
    'start_time' => date('Y-m-d 14:00:00', strtotime('-2 days')),
    'end_time' => date('Y-m-d 15:30:00', strtotime('-2 days')),
    'location' => 'Lounge Tamu',
    'status' => 'approved',
    'created_at' => date('Y-m-d H:i:s', strtotime('-5 days'))
  ],
  [
    'id' => 103,
    'title' => 'Sesi Foto Produk',
