<div class="auth-container">
  <div class="auth-wrapper">
    ...
    <div class="auth-header">
      ...
      <h1 class="auth-title">Agenda Perusahaan</h1>
      <p class="auth-subtitle">Portal manajemen jadwal rapat dan peminjaman ruangan.</p>
    </div>
    ...
    <div class="auth-card">
      ...
      <div class="auth-footer">
        <p class="auth-footer-text">&copy; <?= date('Y') ?> Internal Systems. v1.0</p>
      </div>
    </div>
